/* client/src/components/global/HeroSuministroDeOxido.tsx */
...
const HERO_PANORAMIC_IMAGE = "img-servicios/hero/cal-viva/cal-viva";
const HERO_PANORAMIC_ALT = "Vista panoramica de operacion minera y produccion de cal";

export function HeroSuministroDeOxido() {
  ...
  const heroSlides = [
    {
      poster: "img-servicios/hero/hero-oxido-de-calcio/oxido-de-calcio001",
    },
    {
      poster: "img-servicios/hero/hero-oxido-de-calcio/oxido-de-calcio002",
    },
    {
      poster: "img-servicios/hero/hero-oxido-de-calcio/oxido-de-calcio003",
    },
  ];
  ...
  return (
    <section ref={heroRef} className="relative min-h-[45vh] w-full overflow-hidden bg-black">
        ...
        <div className="mx-auto max-w-7xl px-6 w-full">
          ...
          <div className="max-w-3xl  space-y-6">
            ...
            <h1 className="reveal-title text-5xl lg:text-6xl font-black text-white tracking-tight leading-tight">
              Suministro de Óxido de Calcio Industrial
            </h1>

            <p className="reveal-subtitle text-xl lg:text-2xl font-black text-white/80 tracking-tight leading-tight">
              Producción y comercialización de Óxido de Calcio (Cal Viva), abasteciendo
              principalmente al mercado minero y azucarero a nivel regional y nacional.
            </p>
...
export default HeroSuministroDeOxido;
