...
export default function CommercialCTA({
  ...
  const copy = useLocalizedContent({
    es: {
      ...
      requestEyebrow: "Solicitud comercial",
      requestTitle: "Atención directa para producto, despacho y coordinación operativa",
      requestDescription:
        "Comparta su requerimiento y le brindaremos información técnica, condiciones de suministro y alternativas de atención de acuerdo con las necesidades de su operación.",
      requestButton: "Solicitar cotización",
      whatsappButton: "WhatsApp comercial",
    },
    en: {
      badge: "Commercial support",
      requestEyebrow: "Commercial request",
      requestTitle: "Direct support for product, dispatch, and operational coordination",
      requestDescription:
        "Share your requirement and we will provide technical information, supply conditions, and service alternatives according to your operational needs.",
