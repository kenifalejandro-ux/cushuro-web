...
{/* ... dentro de tu footer */}
<a href="https://www.facebook.com/zincelideas" className="hover:text-white transition-colors">
  <FontAwesomeIcon icon={['fab', 'facebook-f']} className="text-xl" />
</a>
<a href="https://www.tiktok.com/@zincelideas" className="hover:text-white transition-colors">
  <FontAwesomeIcon icon={['fab', 'tiktok']} className="text-xl" />
</a>
<a href="https://www.behance.net/zincelideas" className="hover:text-white transition-colors">
