...
export default function ConfirmationMessage() {
  ...
  return (
    <div className="relative z-10 text-center text-[#1c2526] p-8 bg-white/70  shadow-[0_8px_32px_rgba(0,0,0,0.1)] max-w-[600px] m-4">
      ...
      <button                                   
        className="px-6 py-3  bg-zinc-700 text-white text-base font-medium transition-colors duration-200 hover:bg-[#222]"
        onClick={goBack}
      >
        {copy.button}
      </button>
